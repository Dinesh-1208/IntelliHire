...
const JOININTERVIEW_SERVICE_ID = import.meta.env.VITE_SERVICEID ;
const JOININTERVIEW_USER_ID = import.meta.env.VITE_USERID ;
const JOININTERVIEW_SCORE_TEMPLATE_ID = import.meta.env.VITE_TEMPLATEID_SCORE ;
